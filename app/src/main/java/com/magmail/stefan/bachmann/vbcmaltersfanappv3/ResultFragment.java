...
public class ResultFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragmentView = inflater.inflate(R.layout.fragment_result, container, false);
        mRecyclerView = (RecyclerView) myFragmentView.findViewById(R.id.recycler_view_results);
        ...
        mAdapter = new TeamDisplayAdapter(getActivity(), myDataset, ResultActivity.class);
